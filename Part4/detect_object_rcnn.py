...
print("Indices after NMS:", boxIdxs)
print("Size of boxes array:", len(boxes))

# Flatten the boxIdxs array
boxIdxs = np.concatenate(boxIdxs)
...
for i in boxIdxs:
    if i < len(boxes):
        ...
        print("Invalid index detected:", i)
