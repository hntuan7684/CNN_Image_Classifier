...
# the list of date (i.e., images) and class labels
...
# covert the data and labels to NumPy arrays
...
# construct the head of the model that will be places on top of the 
# base model
...
# make predictiosn on the testing set
