...
for (i, imagePath) in enumerate(imagePaths):
    ...
    # run selective search on the image and initialize 
    # proposed boxes
    ...
    # loop over the rectangles generated bt selective search
    for (x, y, w, h) in rects:
        # convert our bounding boxes from (x, y, w, h) to (startX, 
        # startY, endX, endY)
        proposedRects.append((x, y, x + w, y + h))
       
    # initialize coutner used to count the numebr of positvie and 
    ...
    for proposedRect in proposedRects[:config.MAX_PROPOSALS]:
        ...
        for gtBoxe in gtBoxes:
            ...
            # count limit
            if not fullOverlap and iou < 0.5 and \
